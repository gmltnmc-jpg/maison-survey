...
export const SECTIONS: SectionMeta[] = [
  { code: "basic", no: "01", title: "기본 정보", ey: "Basic Information" },
  {
    code: "consent",
    no: "02",
    title: "개인정보 동의",
  ...
  },
  {
    ...
    no: "03",
    title: "몸의 목표와 기대",
    ey: "Goals & Expectations",
    intro: "이 설문에서 가장 중요한 부분입니다. 원하시는 변화를 있는 그대로 말씀해 주세요.",
  },
  { code: "body_metrics", no: "04", title: "신체 계측", ey: "Body Metrics" },
  {
    code: "diet_history",
    no: "05",
    title: "다이어트 이력",
  ...
  { code: "meal", no: "07", title: "식사 리듬", ey: "Meal Rhythm" },
  { code: "alcohol_caffeine", no: "08", title: "음주 · 카페인", ey: "Alcohol & Caffeine" },
  { code: "hydration", no: "09", title: "수분 리듬", ey: "Water & Mineral" },
  { code: "body_signal", no: "10", title: "몸의 신호", ey: "Body Signals" },
  {
    code: "female",
    no: "11",
    title: "여성 건강 리듬",
  ...
  { code: "medical", no: "12", title: "건강 이력", ey: "Medical History" },
  { code: "lifestyle", no: "13", title: "생활 패턴", ey: "Lifestyle" },
  { code: "family", no: "14", title: "가족력", ey: "Family History" },
  { code: "final", no: "15", title: "마지막 질문", ey: "One Last Thing" },
];
